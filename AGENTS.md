# AGENTS.md — yang-mills-gap

## Role: YM-CLUSTER

**Cluster:** Yang–Mills Mass Gap

**Core claim:** Mass gap certificate — spectral gap of YM Hamiltonian > 0
...
expressed in the language of Yang–Mills Mass Gap.

## Entry point for AI agents

Look for `YangMills` or `Gap` Lean files.

## Siblings in this cluster

| Repo | Role |
|------|------|
| (no siblings in this cluster) | — |
